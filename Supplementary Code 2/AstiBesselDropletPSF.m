%% AstiBesselDropletPSF.m
% The AstiBesselDropletPSF.m calculates the Bessel-droplet PSF (Z=0) generated by a high NA
% objective (NA 0.7) with non-circularly symmetrical aberrations.
folder = fileparts(which(mfilename)); 
addpath(genpath(folder));
ResultPath=[folder '\droplet_0.05xy_z0\'];
...
intensity2(field_rr2>2922&field_rr2<3222)=1;%NA=0.7, R2
